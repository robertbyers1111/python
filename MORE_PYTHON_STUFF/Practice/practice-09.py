...
wtfunc = lambda s: print(*s,sep='\n')

# ANSWER:

l=[1,[22],[3,33,333],('a','b',1,2),{1,2,(11,22)},4444,55555]
prfunc = lambda s: print(*s,sep='\n')
prfunc(l)
...
#
#   dict (11)
#     copy, clear, pop, popitems,
#     items, keys, values, fromkeys,
#     get, update, setdefault
#
#   list (11)
#     append, copy, clear, extend, 
#     sort, index, reverse, remove,
#     count, insert, pop
#
#   frozenset (8)
#     copy, union, intersection, difference,
#     isdisjoint, issuperset, issubset, symmetric_difference
#
#   tuple (2)
#     count, index
#

...
# You want to always use list comprehensions if you need the entire list
# at once for some reason. If neither of these is true, just do whatever
# you want. It's probably good practice to use generator expressions
# unless there's some reason not to, but you're not going to see any real
# difference in efficiency unless the list is very large.

...
if os.path.exists(filename):
  print('\nERROR: Original file',filename,'still exists after attempting to
          rename it to',bbfilename1)
  sys.exit(-1)
...
if not os.path.exists(filename):
  print('\nERROR: Original file',filename,'not successfully retrieved from
          svn')
  sys.exit(-1)
